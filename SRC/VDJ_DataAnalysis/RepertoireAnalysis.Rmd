---
title: "General B-Cell Repertoire Analysis"
output:
  html_document:
    df_print: paged
---
...
plotRepertoireAnalysis <- function(sampleName){
    allContigs <- read.table(paste0(dataDir,"/VDJ_Files/",sampleName,"/ChangeO/HeavyAA_Model/filtered_single_light_heavy_paired_clone-pass.tab"),
