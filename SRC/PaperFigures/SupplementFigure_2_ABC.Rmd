...
```{r echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=5, fig.height=3}
  k <- plotAAChemicalBoxplot(contigs = aaProbsAll,
                        yA="CDR3_aa_length",
                        YLStr="CDR3 AA Length",
                        lYH=c(30,35,40,45))
 
  pdf(file = "./PDFFigures/S2A.pdf", width = 10,  height = 6) 
    k$p2
  dev.off()
  ...
  pdf(file = "./PDFFigures/S2B.pdf", width = 10,  height = 6) 
    k$p2
  dev.off()
  ...
  pdf(file = "./PDFFigures/S2C.pdf", width = 10,  height = 6)
    k$p2
  dev.off()
